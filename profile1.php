                                  ...
                                  <div id="profile" class="tab-pane">
                                    <section class="panel">
                                      ...
                                      <div class="panel-body bio-graph-info">
                                          <h1>Bio Graph</h1>
										    <?php
										  $sql="select * from faculty where id=".$_REQUEST['id'];
										  $res=mysql_query($sql);
...
?>
                                          <div class="row">
                                              <div class="bio-row">
                                                  ...
                                                  <p><span>First Name </span>:<?php echo  $fetch['facultyname'];?></p>
                                              </div>
                                              <div class="bio-row">
                                                  <p><span>fathername </span>: <?php echo  $fetch['fathername'];?></p>
                                              </div>                                              
                                              <div class="bio-row">
                                                  <p><span>Birthday </span>:<?php echo  $fetch['dob'];?></p>
                                              </div>
                                              <div class="bio-row">
                                                  <p><span>username </span>:<?php echo  $fetch['facultyname'];?></p>
                                              </div>
                                              <div class="bio-row">
                                                  <p><span>designation</span>:<?php echo  $fetch['designation'];?></p>
                                              </div>
                                              <div class="bio-row">
                                                  <p><span>Email     </span>:<?php echo  $fetch['email_id'];?></p>
                                              </div>
                                              <div class="bio-row">
                                                  <p><span>Mobile </span>:<?php echo  $fetch['mobile_number'];?></p>
                                              </div>
                                              <div class="bio-row">
                                                  <p><span>pay_scale </span>:  <?php echo  $fetch['pay_scale'];?></p>
                                              </div>
                                          </div>
                                      </div>
                                    </section>
...
?>									
                                           <form class="form-horizontal" role="form" action="update.php" method="post">		  
                                                  <div class="form-group">
                                                      ...
                                                      <div class="col-lg-6">
                                                          <input type="text" name="facultyname" class="form-control" id="f-name" placeholder=" " value="<?php echo $fetch['facultyname'];?>">
                                                      </div>
                                                  </div>
                                                  <div class="form-group">
                                                      <label class="col-lg-2 control-label">Father Name</label>
                                                      <div class="col-lg-6">
                                                          <input type="text" name="fathername" class="form-control" id="l-name" placeholder=" " value="<?php echo $fetch['fathername'];?>">
                                                      </div>
                                                  </div>
                                                  <div class="form-group">
                                                      <label class="col-lg-2 control-label">qualification</label>
                                                      <div class="col-lg-10">
                                                           <input type="text" name="qualification" class="form-control" id="l-name" placeholder=" " value="<?php echo $fetch['qualification'];?>">
                                                      </div>
                                                  </div>
                                                  <div class="form-group">
                                                      <label class="col-lg-2 control-label">department</label>
                                                      <div class="col-lg-6">
                                                          <input type="text" name="department" class="form-control" id="c-name" placeholder=" " value="<?php echo $fetch['department'];?>">
                                                      </div>
                                                  </div>
                                                  <div class="form-group">
                                                      <label class="col-lg-2 control-label">Birthday</label>
                                                      <div class="col-lg-6">
                                                          <input type="text" name="dob" class="form-control" id="b-day" placeholder=" " value="<?php echo $fetch['dob'];?>">
                                                      </div>
                                                  </div>
                                                  <div class="form-group">
                                                      <label class="col-lg-2 control-label">gender</label>
                                                      <div class="col-lg-6">
                                                          <input type="text" name="gender" class="form-control" id="occupation" placeholder=" " value="<?php echo $fetch['gender'];?>">
                                                      </div>
                                                  </div>
                                                  <div class="form-group">
                                                      <label class="col-lg-2 control-label">Email</label>
                                                      <div class="col-lg-6">
                                                          <input type="text" name="email_id" class="form-control" id="email" placeholder=" " value="<?php echo $fetch['email_id'];?>">
                                                      </div>
                                                  </div>
                                                  <div class="form-group">
                                                      <label class="col-lg-2 control-label">Mobile</label>
                                                      <div class="col-lg-6">
                                                          <input type="text" name="mobile_number" class="form-control" id="mobile" placeholder=" " value="<?php echo $fetch['mobile_number'];?>">
                                                      </div>
                                                  </div>
                                                  <div class="form-group">
                                                      <label class="col-lg-2 control-label">Pay scale</label>
                                                      <div class="col-lg-6">
                                                          <input type="text" name="pay_scale" class="form-control" id="url" placeholder="http://www.demowebsite.com " value="<?php echo $fetch['pay_scale'];?>">
                                                      </div>
                                                  </div>
